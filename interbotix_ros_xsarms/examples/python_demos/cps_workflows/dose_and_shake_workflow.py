...
import os
module_path = os.path.abspath('/home/{}/Downloads/ika-master/'.format(username))
...
if __name__ == '__main__':
    ...
    viperx.arm.go_to_home_pose()
    viperx.arm.go_to_sleep_pose()
    # workflow_utils.disconnect_devices(hp=devices['hp'], robot=devices['robot'])
